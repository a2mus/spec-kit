...
2. **Graduated Escalation State Machine**: Modify [check_geofence_status()](file:///f:/Developpement/Projets/Web/Virtual-Fencing---Health-Monitoring-System/simulator/beaglebone_vm.py#149-187) to implement proper escalation:
