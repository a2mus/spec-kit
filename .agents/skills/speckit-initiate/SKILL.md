...
description: Generate project constitution from product and UI specifications. Use
  after brainstorm and uidesign to create development guidelines and best practices.
  Produces constitution.md for the entire development lifecycle.
