---
name: speckit-progress
description: Generate comprehensive progress reports by aggregating data from Memory
  Bank, specs folder, and conversation history. Use to check accomplishments, in-progress
  tasks, blockers, metrics, and recommended next steps.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/progress.md
---

# Speckit Progress Skill
