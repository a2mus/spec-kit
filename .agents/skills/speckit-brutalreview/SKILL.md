...
description: 'Comprehensive end-to-end app review covering code quality, UX, security
  vulnerabilities, performance issues, and product strategy. Generates detailed report
  with critical flaws, architecture concerns, and actionable improvement proposals.
  Saves screenshots to .specify/reviews/screenshots/. Optional focus areas: --focus=security|ux|performance|architecture.
  Auto-detects project type and adjusts review criteria.'
...
- `bin/` or `.specify/scripts/` directory with executable files
