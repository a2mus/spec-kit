...
7. Report completion with branch name, spec file path, checklist results, and readiness for the next phase (`__SPECKIT_COMMAND_CLARIFY__` or `__SPECKIT_COMMAND_PLAN__`).
