---
name: speckit-plan-with-opus
description: Create a detailed implementation plan without writing full code (PLANNING
  ONLY - does NOT execute)
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/plan-with-opus.md
---

# Speckit Plan-With-Opus Skill
