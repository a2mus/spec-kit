...
description: Interactive product brainstorming and specification workflow. Define
  product requirements through guided Q&A with technology recommendations.
...
1. Save the completed specification to `.specify.specify/memory/product-spec.md`.
