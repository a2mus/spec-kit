---
name: speckit-speckit-specify
description: Create feature specification from natural language description (PLANNING
  ONLY - does NOT execute)
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/speckit-specify.md
---

# Speckit Speckit-Specify Skill
