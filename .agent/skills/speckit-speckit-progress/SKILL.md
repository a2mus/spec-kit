---
name: speckit-speckit-progress
description: Check spec progression and present status report with accomplished/in-progress
  tasks and next steps
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/speckit-progress.md
---

# Speckit Speckit-Progress Skill
