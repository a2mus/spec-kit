---
name: speckit-speckit-tasks
description: Generate actionable, dependency-ordered task list from design artifacts
  (PLANNING ONLY - does NOT execute)
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/speckit-tasks.md
---

# Speckit Speckit-Tasks Skill
