---
name: speckit-speckit-clarify
description: Clarify specification requirements before planning (PLANNING ONLY - does
  NOT execute)
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/speckit-clarify.md
---

# Speckit Speckit-Clarify Skill
