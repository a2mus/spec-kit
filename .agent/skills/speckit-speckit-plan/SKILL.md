---
name: speckit-speckit-plan
description: Create technical implementation plan from feature specification (PLANNING
  ONLY - does NOT execute)
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/speckit-plan.md
---

# Speckit Speckit-Plan Skill
